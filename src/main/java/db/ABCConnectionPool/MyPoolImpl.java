...
public class MyPoolImpl implements IMyPool {
    ...
    private void init(){
        ...
        String dbConfigPath=this.getClass().getClassLoader().getResource("").toString().substring(6)+"db/db.properties";

//        InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream(dbConfigPath);
        InputStream inputStream=null;
        try{
            inputStream=new FileInputStream(dbConfigPath);
        }catch (IOException e){}
