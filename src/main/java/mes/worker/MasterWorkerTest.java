...
import mes.mq.worker.MasterWorker;
...
public class MasterWorkerTest {
    static class testHandleRequest {
        public static void main(String[] args){
            MasterWorker master = new MasterWorker(8888);
    ...
    static class testHandleRequestWithUsersInput{
        public static void main(String[] args) throws Exception{
            RequestSimulator rs = new RequestSimulator("localhost",8080);
    ...
    static class testHandleRequestWithoutUserInput{
        public static void main(String[] args){
            RequestSimulator rs = new RequestSimulator("localhost",8888);
            Scanner scan = new Scanner(System.in);
            int i = 0;
            while (i < 100){
